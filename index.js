var phraseContainer = document.getElementById('phrase_container');
var generateButton = document.getElementById('generate_button');
var textField = document.getElementById('generated_text_input');
...
function showPhrase() {
	...
	phraseContainer.style.height = "100%";
}

function getGeneratedPhrase() {
	var randomAdj = adjectives[Math.floor(Math.random() * adjectives.length)].capitalizeFirstLetter() + ' ';
	var randomAnimal = animals[Math.floor(Math.random() * animals.length)];
	var wholePhrase = randomAdj.concat(randomAnimal);
	console.log(wholePhrase);
	textField.value = wholePhrase;
}
